...
class MyMessageBinder(activity: Activity,
                         private val message: Message,
                         val listener: MyMessageBinderListener? =null) :
        RecyclerBinder<BinderViewType>(activity, BinderViewType.MyMessage) {
    ...
    override fun layoutResId(): Int = R.layout.list_item_chat_me
    ...
    interface MyMessageBinderListener {
        fun onMyMessageClicked(message: Message, viewHolder: ViewHolder)
    }
}